...
struct __pyx_ctuple_long__ptr__and_double__ptr__and_int;
typedef struct __pyx_ctuple_long__ptr__and_double__ptr__and_int __pyx_ctuple_long__ptr__and_double__ptr__and_int;

/* "py_kdtree/cython/float64/point_query.pyx":37
...
static int __pyx_f_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(__Pyx_memviewslice, int, __Pyx_memviewslice, int, int, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static __pyx_ctuple_long__ptr__and_double__ptr__and_int __pyx_f_9py_kdtree_6cython_7float64_11point_query__recursive_search_point(int, __Pyx_memviewslice, int, int, __Pyx_memviewslice, int, int, int, int, long *, double *, __Pyx_memviewslice); /*proto*/
...
static PyObject *__pyx_pf_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_point, int __pyx_v_k, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, int __pyx_v_stop_leaves, __Pyx_memviewslice __pyx_v_mmap, __Pyx_memviewslice __pyx_v_indices_view, __Pyx_memviewslice __pyx_v_distances_view); /* proto */
...
static int __pyx_f_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(__Pyx_memviewslice __pyx_v_point, int __pyx_v_k, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, int __pyx_v_stop_leaves, __Pyx_memviewslice __pyx_v_mmap, __Pyx_memviewslice __pyx_v_indices_view, __Pyx_memviewslice __pyx_v_distances_view, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  ...
  int __pyx_t_2;
  int __pyx_t_3;
  __pyx_ctuple_long__ptr__and_double__ptr__and_int __pyx_t_4;
  long *__pyx_t_5;
  double *__pyx_t_6;
 ...
 */
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":18
 *     cdef long depth = 0
 *     cdef long* indices = <long*> malloc(k * sizeof(long))
 *     cdef double* distances =   <double*> malloc(k * sizeof(double))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":20
 *     cdef double* distances =   <double*> malloc(k * sizeof(double))
 * 
 *     try:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":23
 *         #initializes distances
 *         for i in range(k):
 *             distances[i] = INFINITY             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_11point_query__recursive_search_point(0, __pyx_v_point, __pyx_v_k, __pyx_v_depth, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_stop_leaves, __pyx_v_leaf_count, __pyx_v_indices, __pyx_v_distances, __pyx_v_mmap);
 ...
 */
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":29
 *             indices_view[i] = indices[i]
 *             distances_view[i] = distances[i]
 *         return leaf_count             # <<<<<<<<<<<<<<
 *     finally:
 ...
 */
  /*finally:*/ {
    __pyx_L3_return: {
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":32
 *     finally:
 *         free(indices)
 *         free(distances)             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pw_9py_kdtree_6cython_7float64_11point_query_1recursive_search_point(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("recursive_search_point (wrapper)", 0);
  {
    ...
    __pyx_v_mmap = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double__const__(values[6], 0); if (unlikely(!__pyx_v_mmap.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    ...
    __pyx_v_distances_view = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_distances_view.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(__pyx_self, __pyx_v_point, __pyx_v_k, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_stop_leaves, __pyx_v_mmap, __pyx_v_indices_view, __pyx_v_distances_view);
...
static PyObject *__pyx_pf_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_point, int __pyx_v_k, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, int __pyx_v_stop_leaves, __Pyx_memviewslice __pyx_v_mmap, __Pyx_memviewslice __pyx_v_indices_view, __Pyx_memviewslice __pyx_v_distances_view) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(__pyx_v_point, __pyx_v_k, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_stop_leaves, __pyx_v_mmap, __pyx_v_indices_view, __pyx_v_distances_view, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
...
static __pyx_ctuple_long__ptr__and_double__ptr__and_int __pyx_f_9py_kdtree_6cython_7float64_11point_query__recursive_search_point(int __pyx_v_node_idx, __Pyx_memviewslice __pyx_v_point, int __pyx_v_k, int __pyx_v_depth, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, int __pyx_v_stop_leaves, int __pyx_v_leaf_count, long *__pyx_v_indices, double *__pyx_v_distances, __Pyx_memviewslice __pyx_v_mmap) {
  int __pyx_v_l_idx;
  int __pyx_v_r_idx;
  int __pyx_v_axis;
  int __pyx_v_first;
  ...
  __pyx_ctuple_long__ptr__and_double__ptr__and_int __pyx_r;
  long __pyx_t_1;
  long __pyx_t_2;
  int __pyx_t_3;
  __pyx_ctuple_long__ptr__and_double__ptr__and_int __pyx_t_4;
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":40
 *                           int stop_leaves, int leaf_count, long* indices, double* distances,const double[:,:,::1] mmap) nogil:
 *     cdef int l_idx, r_idx,axis,first,second, lf_idx,dist_idx, i,j
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":45
 * 
 *     if leaf_count >= stop_leaves:
 *         return indices,distances,leaf_count             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_v_sub = ((*((double const  *) ( /* dim=2 */ ((char *) (((double const  *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mmap.data + __pyx_t_11 * __pyx_v_mmap.strides[0]) ) + __pyx_t_10 * __pyx_v_mmap.strides[1]) )) + __pyx_t_9)) ))) - (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_point.data) + __pyx_t_15)) ))));
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_kdtree/cython/float64/point_query.pyx":63
 *             max_dist = get_max(distances,k)
 *             if dist < max_dist:
 *                 dist_idx = get_max_idx(distances,k)             # <<<<<<<<<<<<<<
 *                 distances[dist_idx] = dist
 ...
 */
        ...
        /* "py_kdtree/cython/float64/point_query.pyx":65
 *                 dist_idx = get_max_idx(distances,k)
 *                 distances[dist_idx] = dist
 *                 indices[dist_idx] = int(mmap[lf_idx,j,0])             # <<<<<<<<<<<<<<
 *         leaf_count += 1
 ...
 */
        ...
        __pyx_t_9 = __pyx_v_j;
        __pyx_t_10 = 0;
        (__pyx_v_indices[__pyx_v_dist_idx]) = ((long)(*((double const  *) ( /* dim=2 */ ((char *) (((double const  *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mmap.data + __pyx_t_15 * __pyx_v_mmap.strides[0]) ) + __pyx_t_9 * __pyx_v_mmap.strides[1]) )) + __pyx_t_10)) ))));
 ...
 */
    ...
    __pyx_t_15 = 1;
    __pyx_v_median = (*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_tree.data + __pyx_t_10 * __pyx_v_tree.strides[0]) ) + __pyx_t_9 * __pyx_v_tree.strides[1]) )) + __pyx_t_15)) )));
 ...
 */
    ...
    __pyx_t_3 = (((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_point.data) + __pyx_t_15)) ))) < __pyx_v_median) != 0);
    if (__pyx_t_3) {
 ...
 *         max_dist = get_max(distances,k)
 */
    __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_11point_query__recursive_search_point(__pyx_v_first, __pyx_v_point, __pyx_v_k, (__pyx_v_depth + 1), __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_stop_leaves, __pyx_v_leaf_count, __pyx_v_indices, __pyx_v_distances, __pyx_v_mmap);
 ...
 */
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":81
 * 
 *         max_dist = get_max(distances,k)
 *         max_dist_sub = fabs(median - point[axis])             # <<<<<<<<<<<<<<
 *         if max_dist_sub < max_dist:
 ...
 */
    __pyx_t_15 = __pyx_v_axis;
    __pyx_v_max_dist_sub = fabs((__pyx_v_median - (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_point.data) + __pyx_t_15)) )))));

    /* "py_kdtree/cython/float64/point_query.pyx":82
 *         max_dist = get_max(distances,k)
 *         max_dist_sub = fabs(median - point[axis])
 *         if max_dist_sub < max_dist:             # <<<<<<<<<<<<<<
 *             indices,distances,leaf_count = _recursive_search_point(second,point,k,depth+1,tree,n_leaves,n_nodes,stop_leaves,leaf_count,indices,distances,mmap)
 ...
 *         return indices,distances,leaf_count
 */
      __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_11point_query__recursive_search_point(__pyx_v_second, __pyx_v_point, __pyx_v_k, (__pyx_v_depth + 1), __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_stop_leaves, __pyx_v_leaf_count, __pyx_v_indices, __pyx_v_distances, __pyx_v_mmap);
      __pyx_t_16 = __pyx_t_4.f0;
      __pyx_t_17 = __pyx_t_4.f1;
      __pyx_t_8 = __pyx_t_4.f2;
      __pyx_v_indices = __pyx_t_16;
...
static double __pyx_f_9py_kdtree_6cython_7float64_11point_query_get_max(double *__pyx_v_array, int __pyx_v_size) {
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":92
 * cdef double get_max(double* array,int size) nogil:
 *     cdef int i
 *     cdef double MAX = -INFINITY             # <<<<<<<<<<<<<<
 *     for i in range(size):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":94
 *     cdef double MAX = -INFINITY
 *     for i in range(size):
 *         if array[i] > MAX:             # <<<<<<<<<<<<<<
 *             MAX = array[i]
 ...
 */
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":96
 *         if array[i] > MAX:
 *             MAX = array[i]
 *     return MAX             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":104
 *     cdef double MAX = -INFINITY
 *     cdef int idx
 *     for i in range(size):             # <<<<<<<<<<<<<<
 *         if array[i] > MAX:
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":105
 *     cdef int idx
 *     for i in range(size):
 *         if array[i] > MAX:             # <<<<<<<<<<<<<<
 *             MAX = array[i]
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":106
 *     for i in range(size):
 *         if array[i] > MAX:
 *             MAX = array[i]             # <<<<<<<<<<<<<<
 *             idx = i
 ...
 */
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":107
 *         if array[i] > MAX:
 *             MAX = array[i]
 *             idx = i             # <<<<<<<<<<<<<<
 *     return idx
 ...
 */
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":108
 *             MAX = array[i]
 *             idx = i
 *     return idx             # <<<<<<<<<<<<<<
 * 
