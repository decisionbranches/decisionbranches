...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "py_kdtree.cython.float64.box_query",
        "sources": [
            "py_kdtree/cython/float64/box_query.pyx"
        ]
    },
    "module_name": "py_kdtree.cython.float64.box_query"
}
END: Cython Metadata */
...
#define __PYX_HAVE__py_kdtree__cython__float64__box_query
#define __PYX_HAVE_API__py_kdtree__cython__float64__box_query
/* Early includes */
#include <sys/types.h>
#include <signal.h>
#include <sys/time.h>
...
struct __pyx_ctuple_long__ptr__and_long__and_long__and_int;
typedef struct __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_ctuple_long__ptr__and_long__and_long__and_int;

/* "py_kdtree/cython/float64/box_query.pyx":40
...
/* Module declarations from 'py_kdtree.cython.float64.box_query' */
...
static __Pyx_memviewslice __pyx_f_9py_kdtree_6cython_7float64_9box_query_recursive_search_box(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, __Pyx_memviewslice, int, int, double, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box(int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, long *, long, long, __Pyx_memviewslice, long, int, int); /*proto*/
static __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit(int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, long *, long, long, __Pyx_memviewslice, long, int, int, int); /*proto*/
static __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit_leaves(int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, long *, long, long, __Pyx_memviewslice, long, int, int, int); /*proto*/
static int __pyx_f_9py_kdtree_6cython_7float64_9box_query_check_intersect(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static int __pyx_f_9py_kdtree_6cython_7float64_9box_query_check_contained(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static long *__pyx_f_9py_kdtree_6cython_7float64_9box_query_resize_long_array(long *, long, long); /*proto*/
...
#define __Pyx_MODULE_NAME "py_kdtree.cython.float64.box_query"
extern int __pyx_module_is_main_py_kdtree__cython__float64__box_query;
int __pyx_module_is_main_py_kdtree__cython__float64__box_query = 0;

/* Implementation of 'py_kdtree.cython.float64.box_query' */
...
static const char __pyx_k_arr_loaded[] = "arr_loaded";
...
static PyObject *__pyx_n_s_arr_loaded;
...
static PyObject *__pyx_n_s_max_leaves;
...
static PyObject *__pyx_pf_9py_kdtree_6cython_7float64_9box_query_recursive_search_box(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_mins, __Pyx_memviewslice __pyx_v_maxs, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, __Pyx_memviewslice __pyx_v_mmap, int __pyx_v_max_pts, int __pyx_v_max_leaves, double __pyx_v_mem_cap, __Pyx_memviewslice __pyx_v_arr_loaded); /* proto */
...
/* "py_kdtree/cython/float64/box_query.pyx":12
 * @cython.boundscheck(False) # turn off bounds-checking for entire function
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
...
static PyObject *__pyx_pw_9py_kdtree_6cython_7float64_9box_query_1recursive_search_box(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_9py_kdtree_6cython_7float64_9box_query_recursive_search_box(__Pyx_memviewslice __pyx_v_mins, __Pyx_memviewslice __pyx_v_maxs, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, __Pyx_memviewslice __pyx_v_mmap, int __pyx_v_max_pts, int __pyx_v_max_leaves, double __pyx_v_mem_cap, __Pyx_memviewslice __pyx_v_arr_loaded, CYTHON_UNUSED int __pyx_skip_dispatch) {
  __Pyx_memviewslice __pyx_v_indices_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  long __pyx_v_ind_len;
  long __pyx_v_extend_mem;
  long __pyx_v_ind_pt;
  long *__pyx_v_indices;
  int __pyx_v_loaded_leaves;
  long __pyx_v_i;
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_t_2;
  long *__pyx_t_3;
  long __pyx_t_4;
  long __pyx_t_5;
  int __pyx_t_6;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("recursive_search_box", 0);

  /* "py_kdtree/cython/float64/box_query.pyx":15
 *                     int n_nodes,const double[:,:,::1] mmap,int max_pts,int max_leaves,double mem_cap,int[::1] arr_loaded):
 *     cdef long[::1] indices_view
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":16
 *     cdef long[::1] indices_view
 *     cdef long ind_len = int(mmap.shape[0]*mmap.shape[1]*mem_cap)
 *     cdef long extend_mem = ind_len             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":18
 *     cdef long extend_mem = ind_len
 * 
 *     cdef long ind_pt = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":19
 * 
 *     cdef long ind_pt = 0
 *     cdef long* indices = <long*> malloc(ind_len * sizeof(long))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":21
 *     cdef long* indices = <long*> malloc(ind_len * sizeof(long))
 * 
 *     cdef int loaded_leaves = 0             # <<<<<<<<<<<<<<
 * 
 *     try:
 */
  __pyx_v_loaded_leaves = 0;

  /* "py_kdtree/cython/float64/box_query.pyx":23
 *     cdef int loaded_leaves = 0
 * 
 *     try:             # <<<<<<<<<<<<<<
 *         if max_pts > 0:
 ...
 */
  /*try:*/ {
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":24
 * 
 *     try:
 *         if max_pts > 0:             # <<<<<<<<<<<<<<
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(0,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,0)
 *         elif max_leaves > 0:
 */
    __pyx_t_1 = ((__pyx_v_max_pts > 0) != 0);
    if (__pyx_t_1) {

      /* "py_kdtree/cython/float64/box_query.pyx":25
 *     try:
 *         if max_pts > 0:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(0,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,0)             # <<<<<<<<<<<<<<
 *         elif max_leaves > 0:
 ...
 */
      __pyx_t_2 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit(0, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_max_pts, __pyx_v_loaded_leaves, 0);
      __pyx_t_3 = __pyx_t_2.f0;
      __pyx_t_4 = __pyx_t_2.f1;
      __pyx_t_5 = __pyx_t_2.f2;
      __pyx_t_6 = __pyx_t_2.f3;
      __pyx_v_indices = __pyx_t_3;
      __pyx_v_ind_pt = __pyx_t_4;
      __pyx_v_ind_len = __pyx_t_5;
      __pyx_v_loaded_leaves = __pyx_t_6;
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":26
 *         if max_pts > 0:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(0,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,0)
 *         elif max_leaves > 0:             # <<<<<<<<<<<<<<
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(0,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,0)
 *         else:
 */
    __pyx_t_1 = ((__pyx_v_max_leaves > 0) != 0);
    if (__pyx_t_1) {

      /* "py_kdtree/cython/float64/box_query.pyx":27
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(0,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,0)
 *         elif max_leaves > 0:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(0,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,0)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      __pyx_t_2 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit_leaves(0, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_max_leaves, __pyx_v_loaded_leaves, 0);
      __pyx_t_3 = __pyx_t_2.f0;
      __pyx_t_5 = __pyx_t_2.f1;
      __pyx_t_4 = __pyx_t_2.f2;
      __pyx_t_6 = __pyx_t_2.f3;
      __pyx_v_indices = __pyx_t_3;
      __pyx_v_ind_pt = __pyx_t_5;
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":29
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(0,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,0)
 *         else:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(0,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,0)             # <<<<<<<<<<<<<<
 ...
 */
    /*else*/ {
      __pyx_t_2 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box(0, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_loaded_leaves, 0);
      __pyx_t_3 = __pyx_t_2.f0;
      __pyx_t_4 = __pyx_t_2.f1;
      __pyx_t_5 = __pyx_t_2.f2;
      __pyx_t_6 = __pyx_t_2.f3;
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":30
 *         else:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(0,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,0)
 *         arr_loaded[0] = loaded_leaves             # <<<<<<<<<<<<<<
 *         indices_view = np.empty(ind_pt,dtype=np.int64)
 ...
 */
    __pyx_t_7 = 0;
    *((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_arr_loaded.data) + __pyx_t_7)) )) = __pyx_v_loaded_leaves;

    /* "py_kdtree/cython/float64/box_query.pyx":31
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(0,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,0)
 *         arr_loaded[0] = loaded_leaves
 *         indices_view = np.empty(ind_pt,dtype=np.int64)             # <<<<<<<<<<<<<<
 *         for i in range(ind_pt):
 ...
 */
    __Pyx_GetModuleGlobalName(__pyx_t_8, __pyx_n_s_np); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 31, __pyx_L4_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_empty); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 31, __pyx_L4_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyInt_From_long(__pyx_v_ind_pt); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 31, __pyx_L4_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_10 = PyTuple_New(1); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 31, __pyx_L4_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_GIVEREF(__pyx_t_8);
    PyTuple_SET_ITEM(__pyx_t_10, 0, __pyx_t_8);
    __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 31, __pyx_L4_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_GetModuleGlobalName(__pyx_t_11, __pyx_n_s_np); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 31, __pyx_L4_error)
    __Pyx_GOTREF(__pyx_t_11);
    __pyx_t_12 = __Pyx_PyObject_GetAttrStr(__pyx_t_11, __pyx_n_s_int64); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 31, __pyx_L4_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_dtype, __pyx_t_12) < 0) __PYX_ERR(0, 31, __pyx_L4_error)
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_t_12 = __Pyx_PyObject_Call(__pyx_t_9, __pyx_t_10, __pyx_t_8); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 31, __pyx_L4_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_13 = __Pyx_PyObject_to_MemoryviewSlice_dc_long(__pyx_t_12, PyBUF_WRITABLE); if (unlikely(!__pyx_t_13.memview)) __PYX_ERR(0, 31, __pyx_L4_error)
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_v_indices_view = __pyx_t_13;
    __pyx_t_13.memview = NULL;
    __pyx_t_13.data = NULL;

    /* "py_kdtree/cython/float64/box_query.pyx":32
 *         arr_loaded[0] = loaded_leaves
 *         indices_view = np.empty(ind_pt,dtype=np.int64)
 *         for i in range(ind_pt):             # <<<<<<<<<<<<<<
 *             indices_view[i] = indices[i]
 *         return indices_view
 */
    __pyx_t_5 = __pyx_v_ind_pt;
    __pyx_t_4 = __pyx_t_5;
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_4; __pyx_t_14+=1) {
      __pyx_v_i = __pyx_t_14;

      /* "py_kdtree/cython/float64/box_query.pyx":33
 *         indices_view = np.empty(ind_pt,dtype=np.int64)
 *         for i in range(ind_pt):
 *             indices_view[i] = indices[i]             # <<<<<<<<<<<<<<
 *         return indices_view
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":34
 *         for i in range(ind_pt):
 *             indices_view[i] = indices[i]
 *         return indices_view             # <<<<<<<<<<<<<<
 *     finally:
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":36
 *         return indices_view
 *     finally:
 *         free(indices)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("py_kdtree.cython.float64.box_query.recursive_search_box", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_9py_kdtree_6cython_7float64_9box_query_1recursive_search_box(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9py_kdtree_6cython_7float64_9box_query_1recursive_search_box(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  int __pyx_v_max_pts;
  int __pyx_v_max_leaves;
  double __pyx_v_mem_cap;
  __Pyx_memviewslice __pyx_v_arr_loaded = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("recursive_search_box (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_mins,&__pyx_n_s_maxs,&__pyx_n_s_tree,&__pyx_n_s_n_leaves,&__pyx_n_s_n_nodes,&__pyx_n_s_mmap,&__pyx_n_s_max_pts,&__pyx_n_s_max_leaves,&__pyx_n_s_mem_cap,&__pyx_n_s_arr_loaded,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_maxs)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("recursive_search_box", 1, 10, 10, 1); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_tree)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("recursive_search_box", 1, 10, 10, 2); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_leaves)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("recursive_search_box", 1, 10, 10, 3); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_nodes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("recursive_search_box", 1, 10, 10, 4); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mmap)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("recursive_search_box", 1, 10, 10, 5); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_pts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("recursive_search_box", 1, 10, 10, 6); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_leaves)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("recursive_search_box", 1, 10, 10, 7); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mem_cap)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("recursive_search_box", 1, 10, 10, 8); __PYX_ERR(0, 12, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_arr_loaded)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("recursive_search_box", 1, 10, 10, 9); __PYX_ERR(0, 12, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "recursive_search_box") < 0)) __PYX_ERR(0, 12, __pyx_L3_error)
      }
    ...
    __pyx_v_mins = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_mins.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_maxs = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_maxs.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    ...
    __pyx_v_max_pts = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_max_pts == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_max_leaves = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_max_leaves == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_mem_cap = __pyx_PyFloat_AsDouble(values[8]); if (unlikely((__pyx_v_mem_cap == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_arr_loaded = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[9], PyBUF_WRITABLE); if (unlikely(!__pyx_v_arr_loaded.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("recursive_search_box", 1, 10, 10, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 12, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("py_kdtree.cython.float64.box_query.recursive_search_box", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9py_kdtree_6cython_7float64_9box_query_recursive_search_box(__pyx_self, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_mmap, __pyx_v_max_pts, __pyx_v_max_leaves, __pyx_v_mem_cap, __pyx_v_arr_loaded);
...
static PyObject *__pyx_pf_9py_kdtree_6cython_7float64_9box_query_recursive_search_box(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_mins, __Pyx_memviewslice __pyx_v_maxs, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, __Pyx_memviewslice __pyx_v_mmap, int __pyx_v_max_pts, int __pyx_v_max_leaves, double __pyx_v_mem_cap, __Pyx_memviewslice __pyx_v_arr_loaded) {
  ...
  if (unlikely(!__pyx_v_mins.memview)) { __Pyx_RaiseUnboundLocalError("mins"); __PYX_ERR(0, 12, __pyx_L1_error) }
  if (unlikely(!__pyx_v_maxs.memview)) { __Pyx_RaiseUnboundLocalError("maxs"); __PYX_ERR(0, 12, __pyx_L1_error) }
  ...
  if (unlikely(!__pyx_v_arr_loaded.memview)) { __Pyx_RaiseUnboundLocalError("arr_loaded"); __PYX_ERR(0, 12, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_9py_kdtree_6cython_7float64_9box_query_recursive_search_box(__pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_mmap, __pyx_v_max_pts, __pyx_v_max_leaves, __pyx_v_mem_cap, __pyx_v_arr_loaded, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 12, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 1, (PyObject *(*)(char *)) __pyx_memview_get_long, (int (*)(char *, PyObject *)) __pyx_memview_set_long, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_arr_loaded, 1);
...
static __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box(int __pyx_v_node_idx, __Pyx_memviewslice __pyx_v_mins, __Pyx_memviewslice __pyx_v_maxs, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, long *__pyx_v_indices, long __pyx_v_ind_pt, long __pyx_v_ind_len, __Pyx_memviewslice __pyx_v_mmap, long __pyx_v_extend_mem, int __pyx_v_loaded_leaves, int __pyx_v_contained) {
  int __pyx_v_l_idx;
  int __pyx_v_r_idx;
  int __pyx_v_ret;
  int __pyx_v_lf_idx;
  ...
  double __pyx_v_leaf_val;
  __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_r;
  long __pyx_t_1;
  long __pyx_t_2;
  int __pyx_t_3;
  int __pyx_t_4;
  ...
  __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_t_11;
  long *__pyx_t_12;
  __Pyx_memviewslice __pyx_t_13 = { 0, 0, { 0 }, { 0 }, { 0 } };

  /* "py_kdtree/cython/float64/box_query.pyx":43
 *                           long* indices, long ind_pt,long ind_len,const double[:,:,::1] mmap,long extend_mem, int loaded_leaves, int contained) nogil:
 *     cdef int l_idx, r_idx,intersects, ret,lf_idx,isin,j,k
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":48
 * 
 *     ############################## Leaf ##########################################################################
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":49
 *     ############################## Leaf ##########################################################################
 *     if (l_idx >= tree.shape[0]) and (r_idx >= tree.shape[0]):
 *         lf_idx = n_leaves+node_idx-n_nodes             # <<<<<<<<<<<<<<
 *         loaded_leaves += 1
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":50
 *     if (l_idx >= tree.shape[0]) and (r_idx >= tree.shape[0]):
 *         lf_idx = n_leaves+node_idx-n_nodes
 *         loaded_leaves += 1             # <<<<<<<<<<<<<<
 *         if contained == 1:
 ...
 */
    __pyx_v_loaded_leaves = (__pyx_v_loaded_leaves + 1);

    /* "py_kdtree/cython/float64/box_query.pyx":51
 *         lf_idx = n_leaves+node_idx-n_nodes
 *         loaded_leaves += 1
 *         if contained == 1:             # <<<<<<<<<<<<<<
 *             for j in range(mmap.shape[1]):
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":52
 *         loaded_leaves += 1
 *         if contained == 1:
 *             for j in range(mmap.shape[1]):             # <<<<<<<<<<<<<<
 *                 if j == mmap.shape[1]-1:
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":53
 *         if contained == 1:
 *             for j in range(mmap.shape[1]):
 *                 if j == mmap.shape[1]-1:             # <<<<<<<<<<<<<<
 *                     if mmap[lf_idx,j,0] == -1.:
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":54
 *             for j in range(mmap.shape[1]):
 *                 if j == mmap.shape[1]-1:
 *                     if mmap[lf_idx,j,0] == -1.:             # <<<<<<<<<<<<<<
 *                         continue
 ...
 */
          ...
          if (__pyx_t_3) {
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":55
 *                 if j == mmap.shape[1]-1:
 *                     if mmap[lf_idx,j,0] == -1.:
 *                         continue             # <<<<<<<<<<<<<<
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":56
 *                     if mmap[lf_idx,j,0] == -1.:
 *                         continue
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])             # <<<<<<<<<<<<<<
 *                 ind_pt += 1
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":57
 *                         continue
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])
 *                 ind_pt += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":59
 *                 ind_pt += 1
 * 
 *                 if ind_pt == ind_len:             # <<<<<<<<<<<<<<
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":60
 * 
 *                 if ind_pt == ind_len:
 *                     indices = resize_long_array(indices,ind_len,ind_len+extend_mem)             # <<<<<<<<<<<<<<
 *                     ind_len += extend_mem
 *         else:
 */
          __pyx_v_indices = __pyx_f_9py_kdtree_6cython_7float64_9box_query_resize_long_array(__pyx_v_indices, __pyx_v_ind_len, (__pyx_v_ind_len + __pyx_v_extend_mem));

          /* "py_kdtree/cython/float64/box_query.pyx":61
 *                 if ind_pt == ind_len:
 *                     indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 *                     ind_len += extend_mem             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":63
 *                     ind_len += extend_mem
 *         else:
 *             for j in range(mmap.shape[1]):             # <<<<<<<<<<<<<<
 *                 k = 0
 ...
 */
    /*else*/ {
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":64
 *         else:
 *             for j in range(mmap.shape[1]):
 *                 k = 0             # <<<<<<<<<<<<<<
 *                 isin = 0
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":65
 *             for j in range(mmap.shape[1]):
 *                 k = 0
 *                 isin = 0             # <<<<<<<<<<<<<<
 *                 while (k < mmap.shape[2]-1) and (isin == k):
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":66
 *                 k = 0
 *                 isin = 0
 *                 while (k < mmap.shape[2]-1) and (isin == k):             # <<<<<<<<<<<<<<
 *                     if j == mmap.shape[1]-1:
 ...
 */
        while (1) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":67
 *                 isin = 0
 *                 while (k < mmap.shape[2]-1) and (isin == k):
 *                     if j == mmap.shape[1]-1:             # <<<<<<<<<<<<<<
 *                         if mmap[lf_idx,j,0] == -1.:
 ...
 */
          ...
          if (__pyx_t_3) {
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":68
 *                 while (k < mmap.shape[2]-1) and (isin == k):
 *                     if j == mmap.shape[1]-1:
 *                         if mmap[lf_idx,j,0] == -1.:             # <<<<<<<<<<<<<<
 *                             k += 1
 ...
 */
            ...
            if (__pyx_t_3) {
              ...
              /* "py_kdtree/cython/float64/box_query.pyx":69
 *                     if j == mmap.shape[1]-1:
 *                         if mmap[lf_idx,j,0] == -1.:
 *                             k += 1             # <<<<<<<<<<<<<<
 *                             continue
 ...
 */
              ...
              /* "py_kdtree/cython/float64/box_query.pyx":70
 *                         if mmap[lf_idx,j,0] == -1.:
 *                             k += 1
 *                             continue             # <<<<<<<<<<<<<<
 *                     leaf_val = mmap[lf_idx,j,k+1]
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":71
 *                             k += 1
 *                             continue
 *                     leaf_val = mmap[lf_idx,j,k+1]             # <<<<<<<<<<<<<<
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):
 ...
 */
          ...
          __pyx_v_leaf_val = (*((double const  *) ( /* dim=2 */ ((char *) (((double const  *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mmap.data + __pyx_t_10 * __pyx_v_mmap.strides[0]) ) + __pyx_t_9 * __pyx_v_mmap.strides[1]) )) + __pyx_t_8)) )));

          /* "py_kdtree/cython/float64/box_query.pyx":72
 *                             continue
 *                     leaf_val = mmap[lf_idx,j,k+1]
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):             # <<<<<<<<<<<<<<
 *                         isin += 1
 ...
 */
          __pyx_t_8 = __pyx_v_k;
          __pyx_t_4 = ((__pyx_v_leaf_val >= (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_mins.data) + __pyx_t_8)) )))) != 0);
          if (__pyx_t_4) {
          } else {
            __pyx_t_3 = __pyx_t_4;
          ...
          __pyx_t_8 = __pyx_v_k;
          __pyx_t_4 = ((__pyx_v_leaf_val <= (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_maxs.data) + __pyx_t_8)) )))) != 0);
          __pyx_t_3 = __pyx_t_4;
          __pyx_L21_bool_binop_done:;
          if (__pyx_t_3) {

            /* "py_kdtree/cython/float64/box_query.pyx":73
 *                     leaf_val = mmap[lf_idx,j,k+1]
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):
 *                         isin += 1             # <<<<<<<<<<<<<<
 *                     k += 1
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":74
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):
 *                         isin += 1
 *                     k += 1             # <<<<<<<<<<<<<<
 *                 if isin == k:
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":75
 *                         isin += 1
 *                     k += 1
 *                 if isin == k:             # <<<<<<<<<<<<<<
 *                     indices[ind_pt] = int(mmap[lf_idx,j,0])
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":76
 *                     k += 1
 *                 if isin == k:
 *                     indices[ind_pt] = int(mmap[lf_idx,j,0])             # <<<<<<<<<<<<<<
 *                     ind_pt += 1
 ...
 */
          ...
          __pyx_t_9 = __pyx_v_j;
          __pyx_t_10 = 0;
          (__pyx_v_indices[__pyx_v_ind_pt]) = ((long)(*((double const  *) ( /* dim=2 */ ((char *) (((double const  *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mmap.data + __pyx_t_8 * __pyx_v_mmap.strides[0]) ) + __pyx_t_9 * __pyx_v_mmap.strides[1]) )) + __pyx_t_10)) ))));

          /* "py_kdtree/cython/float64/box_query.pyx":77
 *                 if isin == k:
 *                     indices[ind_pt] = int(mmap[lf_idx,j,0])
 *                     ind_pt += 1             # <<<<<<<<<<<<<<
 *                     if ind_pt == ind_len:
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":78
 *                     indices[ind_pt] = int(mmap[lf_idx,j,0])
 *                     ind_pt += 1
 *                     if ind_pt == ind_len:             # <<<<<<<<<<<<<<
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 ...
 */
          ...
          if (__pyx_t_3) {
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":79
 *                     ind_pt += 1
 *                     if ind_pt == ind_len:
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)             # <<<<<<<<<<<<<<
 *                         ind_len += extend_mem
 ...
 */
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":80
 *                     if ind_pt == ind_len:
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 *                         ind_len += extend_mem             # <<<<<<<<<<<<<<
 *         return indices,ind_pt,ind_len,loaded_leaves
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":81
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 *                         ind_len += extend_mem
 *         return indices,ind_pt,ind_len,loaded_leaves             # <<<<<<<<<<<<<<
 *     ############################## Normal node ##########################################################################
 *     else:
 */
    __pyx_t_11.f0 = __pyx_v_indices;
    __pyx_t_11.f1 = __pyx_v_ind_pt;
    __pyx_t_11.f2 = __pyx_v_ind_len;
    __pyx_t_11.f3 = __pyx_v_loaded_leaves;
    __pyx_r = __pyx_t_11;
    goto __pyx_L0;
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":84
 *     ############################## Normal node ##########################################################################
 *     else:
 *         if contained == 1:             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    ...
    if (__pyx_t_3) {
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":85
 *     else:
 *         if contained == 1:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)
 *         else:
 */
      __pyx_t_11 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box(__pyx_v_l_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_loaded_leaves, 1);
      __pyx_t_12 = __pyx_t_11.f0;
      __pyx_t_2 = __pyx_t_11.f1;
      __pyx_t_1 = __pyx_t_11.f2;
      __pyx_t_7 = __pyx_t_11.f3;
      __pyx_v_indices = __pyx_t_12;
      __pyx_v_ind_pt = __pyx_t_2;
      __pyx_v_ind_len = __pyx_t_1;
      __pyx_v_loaded_leaves = __pyx_t_7;

      /* "py_kdtree/cython/float64/box_query.pyx":86
 *         if contained == 1:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *         else:
 *             l_bounds = tree[l_idx]
 */
      __pyx_t_11 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box(__pyx_v_r_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_loaded_leaves, 1);
      __pyx_t_12 = __pyx_t_11.f0;
      __pyx_t_1 = __pyx_t_11.f1;
      __pyx_t_2 = __pyx_t_11.f2;
      __pyx_t_7 = __pyx_t_11.f3;
      __pyx_v_indices = __pyx_t_12;
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":88
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)
 *         else:
 *             l_bounds = tree[l_idx]             # <<<<<<<<<<<<<<
 *             r_bounds = tree[r_idx]
 ...
 */
    /*else*/ {
      __pyx_t_13.data = __pyx_v_tree.data;
      __pyx_t_13.memview = __pyx_v_tree.memview;
...
__pyx_t_13.shape[0] = __pyx_v_tree.shape[1];
__pyx_t_13.strides[0] = __pyx_v_tree.strides[1];
    __pyx_t_13.suboffsets[0] = -1;

__pyx_t_13.shape[1] = __pyx_v_tree.shape[2];
__pyx_t_13.strides[1] = __pyx_v_tree.strides[2];
    __pyx_t_13.suboffsets[1] = -1;

__pyx_v_l_bounds = __pyx_t_13;
      __pyx_t_13.memview = NULL;
      __pyx_t_13.data = NULL;

      /* "py_kdtree/cython/float64/box_query.pyx":89
 *         else:
 *             l_bounds = tree[l_idx]
 *             r_bounds = tree[r_idx]             # <<<<<<<<<<<<<<
 *             ret = check_contained(l_bounds,mins,maxs)
...
__pyx_v_r_bounds = __pyx_t_13;
      __pyx_t_13.memview = NULL;
      __pyx_t_13.data = NULL;

      /* "py_kdtree/cython/float64/box_query.pyx":90
 *             l_bounds = tree[l_idx]
 *             r_bounds = tree[r_idx]
 *             ret = check_contained(l_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *             if ret == 1:
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)
 */
      __pyx_v_ret = __pyx_f_9py_kdtree_6cython_7float64_9box_query_check_contained(__pyx_v_l_bounds, __pyx_v_mins, __pyx_v_maxs);

      /* "py_kdtree/cython/float64/box_query.pyx":91
 *             r_bounds = tree[r_idx]
 *             ret = check_contained(l_bounds,mins,maxs)
 *             if ret == 1:             # <<<<<<<<<<<<<<
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":92
 *             ret = check_contained(l_bounds,mins,maxs)
 *             if ret == 1:
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":94
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)
 *             else:
 *                 ret = check_intersect(l_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *                 if ret == 1:
 ...
 */
      /*else*/ {
        __pyx_v_ret = __pyx_f_9py_kdtree_6cython_7float64_9box_query_check_intersect(__pyx_v_l_bounds, __pyx_v_mins, __pyx_v_maxs);

        /* "py_kdtree/cython/float64/box_query.pyx":95
 *             else:
 *                 ret = check_intersect(l_bounds,mins,maxs)
 *                 if ret == 1:             # <<<<<<<<<<<<<<
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,0)
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":96
 *                 ret = check_intersect(l_bounds,mins,maxs)
 *                 if ret == 1:
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_t_11 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box(__pyx_v_l_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_loaded_leaves, 0);
          __pyx_t_12 = __pyx_t_11.f0;
          __pyx_t_1 = __pyx_t_11.f1;
          __pyx_t_2 = __pyx_t_11.f2;
          __pyx_t_7 = __pyx_t_11.f3;
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":98
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,0)
 * 
 *             ret = check_contained(r_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *             if ret == 1:
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)
 */
      __pyx_v_ret = __pyx_f_9py_kdtree_6cython_7float64_9box_query_check_contained(__pyx_v_r_bounds, __pyx_v_mins, __pyx_v_maxs);

      /* "py_kdtree/cython/float64/box_query.pyx":99
 * 
 *             ret = check_contained(r_bounds,mins,maxs)
 *             if ret == 1:             # <<<<<<<<<<<<<<
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":100
 *             ret = check_contained(r_bounds,mins,maxs)
 *             if ret == 1:
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":102
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,1)
 *             else:
 *                 ret = check_intersect(r_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *                 if ret == 1:
 ...
 */
      /*else*/ {
        __pyx_v_ret = __pyx_f_9py_kdtree_6cython_7float64_9box_query_check_intersect(__pyx_v_r_bounds, __pyx_v_mins, __pyx_v_maxs);

        /* "py_kdtree/cython/float64/box_query.pyx":103
 *             else:
 *                 ret = check_intersect(r_bounds,mins,maxs)
 *                 if ret == 1:             # <<<<<<<<<<<<<<
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,0)
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":104
 *                 ret = check_intersect(r_bounds,mins,maxs)
 *                 if ret == 1:
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,0)             # <<<<<<<<<<<<<<
 * 
 *     return indices,ind_pt,ind_len,loaded_leaves
 */
          __pyx_t_11 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box(__pyx_v_r_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_loaded_leaves, 0);
          __pyx_t_12 = __pyx_t_11.f0;
          __pyx_t_1 = __pyx_t_11.f1;
          __pyx_t_2 = __pyx_t_11.f2;
          __pyx_t_7 = __pyx_t_11.f3;
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":106
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,loaded_leaves,0)
 * 
 *     return indices,ind_pt,ind_len,loaded_leaves             # <<<<<<<<<<<<<<
 * 
...
/* "py_kdtree/cython/float64/box_query.pyx":110
 * @cython.boundscheck(False) # turn off bounds-checking for entire function
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
...
static __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit(int __pyx_v_node_idx, __Pyx_memviewslice __pyx_v_mins, __Pyx_memviewslice __pyx_v_maxs, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, long *__pyx_v_indices, long __pyx_v_ind_pt, long __pyx_v_ind_len, __Pyx_memviewslice __pyx_v_mmap, long __pyx_v_extend_mem, int __pyx_v_max_pts, int __pyx_v_loaded_leaves, int __pyx_v_contained) {
  int __pyx_v_l_idx;
  int __pyx_v_r_idx;
  int __pyx_v_ret;
  int __pyx_v_lf_idx;
  ...
  long __pyx_t_2;
  int __pyx_t_3;
  __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_t_4;
  int __pyx_t_5;
  Py_ssize_t __pyx_t_6;
  Py_ssize_t __pyx_t_7;
  int __pyx_t_8;
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":113
 *                           long* indices, long ind_pt,long ind_len,const double[:,:,::1] mmap,long extend_mem, int max_pts,int loaded_leaves, int contained) nogil:
 *     cdef int l_idx, r_idx,intersects, ret,lf_idx,isin,j,k
 *     l_idx,r_idx = (2*node_idx)+1, (2*node_idx)+2             # <<<<<<<<<<<<<<
 *     cdef double[:,:] bounds,l_bounds,r_bounds
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":117
 *     cdef double leaf_val
 * 
 *     if ind_pt == max_pts:             # <<<<<<<<<<<<<<
 *         return indices,ind_pt,ind_len,loaded_leaves
 *     ############################## Leaf ##########################################################################
 */
  __pyx_t_3 = ((__pyx_v_ind_pt == __pyx_v_max_pts) != 0);
  if (__pyx_t_3) {

    /* "py_kdtree/cython/float64/box_query.pyx":118
 * 
 *     if ind_pt == max_pts:
 *         return indices,ind_pt,ind_len,loaded_leaves             # <<<<<<<<<<<<<<
 *     ############################## Leaf ##########################################################################
 *     if (l_idx >= tree.shape[0]) and (r_idx >= tree.shape[0]):
 */
    __pyx_t_4.f0 = __pyx_v_indices;
    __pyx_t_4.f1 = __pyx_v_ind_pt;
    __pyx_t_4.f2 = __pyx_v_ind_len;
    __pyx_t_4.f3 = __pyx_v_loaded_leaves;
    __pyx_r = __pyx_t_4;
    goto __pyx_L0;
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":120
 *         return indices,ind_pt,ind_len,loaded_leaves
 *     ############################## Leaf ##########################################################################
 *     if (l_idx >= tree.shape[0]) and (r_idx >= tree.shape[0]):             # <<<<<<<<<<<<<<
 *         lf_idx = n_leaves+node_idx-n_nodes
 *         loaded_leaves += 1
 */
  __pyx_t_5 = ((__pyx_v_l_idx >= (__pyx_v_tree.shape[0])) != 0);
  if (__pyx_t_5) {
  } else {
    __pyx_t_3 = __pyx_t_5;
    goto __pyx_L5_bool_binop_done;
  }
  __pyx_t_5 = ((__pyx_v_r_idx >= (__pyx_v_tree.shape[0])) != 0);
  __pyx_t_3 = __pyx_t_5;
  __pyx_L5_bool_binop_done:;
  if (__pyx_t_3) {

    /* "py_kdtree/cython/float64/box_query.pyx":121
 *     ############################## Leaf ##########################################################################
 *     if (l_idx >= tree.shape[0]) and (r_idx >= tree.shape[0]):
 *         lf_idx = n_leaves+node_idx-n_nodes             # <<<<<<<<<<<<<<
 *         loaded_leaves += 1
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":122
 *     if (l_idx >= tree.shape[0]) and (r_idx >= tree.shape[0]):
 *         lf_idx = n_leaves+node_idx-n_nodes
 *         loaded_leaves += 1             # <<<<<<<<<<<<<<
 *         if contained == 1:
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":123
 *         lf_idx = n_leaves+node_idx-n_nodes
 *         loaded_leaves += 1
 *         if contained == 1:             # <<<<<<<<<<<<<<
 *             for j in range(mmap.shape[1]):
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":124
 *         loaded_leaves += 1
 *         if contained == 1:
 *             for j in range(mmap.shape[1]):             # <<<<<<<<<<<<<<
 *                 if j == mmap.shape[1]-1:
 *                     if mmap[lf_idx,j,0] == -1.:
 */
      __pyx_t_6 = (__pyx_v_mmap.shape[1]);
      __pyx_t_7 = __pyx_t_6;
      for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
        __pyx_v_j = __pyx_t_8;

        /* "py_kdtree/cython/float64/box_query.pyx":125
 *         if contained == 1:
 *             for j in range(mmap.shape[1]):
 *                 if j == mmap.shape[1]-1:             # <<<<<<<<<<<<<<
 *                     if mmap[lf_idx,j,0] == -1.:
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":126
 *             for j in range(mmap.shape[1]):
 *                 if j == mmap.shape[1]-1:
 *                     if mmap[lf_idx,j,0] == -1.:             # <<<<<<<<<<<<<<
 *                         continue
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])
 */
          __pyx_t_9 = __pyx_v_lf_idx;
          __pyx_t_10 = __pyx_v_j;
          __pyx_t_11 = 0;
          __pyx_t_3 = (((*((double const  *) ( /* dim=2 */ ((char *) (((double const  *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mmap.data + __pyx_t_9 * __pyx_v_mmap.strides[0]) ) + __pyx_t_10 * __pyx_v_mmap.strides[1]) )) + __pyx_t_11)) ))) == -1.) != 0);
          if (__pyx_t_3) {

            /* "py_kdtree/cython/float64/box_query.pyx":127
 *                 if j == mmap.shape[1]-1:
 *                     if mmap[lf_idx,j,0] == -1.:
 *                         continue             # <<<<<<<<<<<<<<
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":128
 *                     if mmap[lf_idx,j,0] == -1.:
 *                         continue
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])             # <<<<<<<<<<<<<<
 *                 ind_pt += 1
 ...
 */
        ...
        __pyx_t_10 = __pyx_v_j;
        __pyx_t_9 = 0;
        (__pyx_v_indices[__pyx_v_ind_pt]) = ((long)(*((double const  *) ( /* dim=2 */ ((char *) (((double const  *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mmap.data + __pyx_t_11 * __pyx_v_mmap.strides[0]) ) + __pyx_t_10 * __pyx_v_mmap.strides[1]) )) + __pyx_t_9)) ))));

        /* "py_kdtree/cython/float64/box_query.pyx":129
 *                         continue
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])
 *                 ind_pt += 1             # <<<<<<<<<<<<<<
 *                 if ind_pt == max_pts:
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":130
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])
 *                 ind_pt += 1
 *                 if ind_pt == max_pts:             # <<<<<<<<<<<<<<
 *                     return indices,ind_pt,ind_len,loaded_leaves
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":131
 *                 ind_pt += 1
 *                 if ind_pt == max_pts:
 *                     return indices,ind_pt,ind_len,loaded_leaves             # <<<<<<<<<<<<<<
 *                 if ind_pt == ind_len:
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":132
 *                 if ind_pt == max_pts:
 *                     return indices,ind_pt,ind_len,loaded_leaves
 *                 if ind_pt == ind_len:             # <<<<<<<<<<<<<<
 *                     indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":133
 *                     return indices,ind_pt,ind_len,loaded_leaves
 *                 if ind_pt == ind_len:
 *                     indices = resize_long_array(indices,ind_len,ind_len+extend_mem)             # <<<<<<<<<<<<<<
 *                     ind_len += extend_mem
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":134
 *                 if ind_pt == ind_len:
 *                     indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 *                     ind_len += extend_mem             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":136
 *                     ind_len += extend_mem
 *         else:
 *             for j in range(mmap.shape[1]):             # <<<<<<<<<<<<<<
 *                 k = 0
 ...
 */
    /*else*/ {
      ...
      for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":137
 *         else:
 *             for j in range(mmap.shape[1]):
 *                 k = 0             # <<<<<<<<<<<<<<
 *                 isin = 0
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":138
 *             for j in range(mmap.shape[1]):
 *                 k = 0
 *                 isin = 0             # <<<<<<<<<<<<<<
 *                 while (k < mmap.shape[2]-1) and (isin == k):
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":139
 *                 k = 0
 *                 isin = 0
 *                 while (k < mmap.shape[2]-1) and (isin == k):             # <<<<<<<<<<<<<<
 *                     if j == mmap.shape[1]-1:
 ...
 */
        while (1) {
          __pyx_t_5 = ((__pyx_v_k < ((__pyx_v_mmap.shape[2]) - 1)) != 0);
          if (__pyx_t_5) {
          } else {
            __pyx_t_3 = __pyx_t_5;
            goto __pyx_L18_bool_binop_done;
          }
          __pyx_t_5 = ((__pyx_v_isin == __pyx_v_k) != 0);
          __pyx_t_3 = __pyx_t_5;
          __pyx_L18_bool_binop_done:;
          if (!__pyx_t_3) break;

          /* "py_kdtree/cython/float64/box_query.pyx":140
 *                 isin = 0
 *                 while (k < mmap.shape[2]-1) and (isin == k):
 *                     if j == mmap.shape[1]-1:             # <<<<<<<<<<<<<<
 *                         if mmap[lf_idx,j,0] == -1.:
 ...
 */
          ...
          if (__pyx_t_3) {
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":141
 *                 while (k < mmap.shape[2]-1) and (isin == k):
 *                     if j == mmap.shape[1]-1:
 *                         if mmap[lf_idx,j,0] == -1.:             # <<<<<<<<<<<<<<
 *                             k += 1
 ...
 */
            ...
            if (__pyx_t_3) {
              ...
              /* "py_kdtree/cython/float64/box_query.pyx":142
 *                     if j == mmap.shape[1]-1:
 *                         if mmap[lf_idx,j,0] == -1.:
 *                             k += 1             # <<<<<<<<<<<<<<
 *                             continue
 ...
 */
              ...
              /* "py_kdtree/cython/float64/box_query.pyx":143
 *                         if mmap[lf_idx,j,0] == -1.:
 *                             k += 1
 *                             continue             # <<<<<<<<<<<<<<
 *                     leaf_val = mmap[lf_idx,j,k+1]
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":144
 *                             k += 1
 *                             continue
 *                     leaf_val = mmap[lf_idx,j,k+1]             # <<<<<<<<<<<<<<
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):
 ...
 */
          ...
          __pyx_v_leaf_val = (*((double const  *) ( /* dim=2 */ ((char *) (((double const  *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mmap.data + __pyx_t_11 * __pyx_v_mmap.strides[0]) ) + __pyx_t_10 * __pyx_v_mmap.strides[1]) )) + __pyx_t_9)) )));

          /* "py_kdtree/cython/float64/box_query.pyx":145
 *                             continue
 *                     leaf_val = mmap[lf_idx,j,k+1]
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):             # <<<<<<<<<<<<<<
 *                         isin += 1
 ...
 */
          __pyx_t_9 = __pyx_v_k;
          __pyx_t_5 = ((__pyx_v_leaf_val >= (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_mins.data) + __pyx_t_9)) )))) != 0);
          if (__pyx_t_5) {
          } else {
            __pyx_t_3 = __pyx_t_5;
          ...
          __pyx_t_9 = __pyx_v_k;
          __pyx_t_5 = ((__pyx_v_leaf_val <= (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_maxs.data) + __pyx_t_9)) )))) != 0);
          __pyx_t_3 = __pyx_t_5;
          __pyx_L23_bool_binop_done:;
          if (__pyx_t_3) {

            /* "py_kdtree/cython/float64/box_query.pyx":146
 *                     leaf_val = mmap[lf_idx,j,k+1]
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):
 *                         isin += 1             # <<<<<<<<<<<<<<
 *                     k += 1
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":147
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):
 *                         isin += 1
 *                     k += 1             # <<<<<<<<<<<<<<
 *                 if isin == k:
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":148
 *                         isin += 1
 *                     k += 1
 *                 if isin == k:             # <<<<<<<<<<<<<<
 *                     indices[ind_pt] = int(mmap[lf_idx,j,0])
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":149
 *                     k += 1
 *                 if isin == k:
 *                     indices[ind_pt] = int(mmap[lf_idx,j,0])             # <<<<<<<<<<<<<<
 *                     ind_pt += 1
 ...
 */
          ...
          __pyx_t_10 = __pyx_v_j;
          __pyx_t_11 = 0;
          (__pyx_v_indices[__pyx_v_ind_pt]) = ((long)(*((double const  *) ( /* dim=2 */ ((char *) (((double const  *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mmap.data + __pyx_t_9 * __pyx_v_mmap.strides[0]) ) + __pyx_t_10 * __pyx_v_mmap.strides[1]) )) + __pyx_t_11)) ))));

          /* "py_kdtree/cython/float64/box_query.pyx":150
 *                 if isin == k:
 *                     indices[ind_pt] = int(mmap[lf_idx,j,0])
 *                     ind_pt += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":152
 *                     ind_pt += 1
 * 
 *                     if ind_pt == max_pts:             # <<<<<<<<<<<<<<
 *                         return indices,ind_pt,ind_len,loaded_leaves
 ...
 */
          ...
          if (__pyx_t_3) {
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":153
 * 
 *                     if ind_pt == max_pts:
 *                         return indices,ind_pt,ind_len,loaded_leaves             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":155
 *                         return indices,ind_pt,ind_len,loaded_leaves
 * 
 *                     if ind_pt == ind_len:             # <<<<<<<<<<<<<<
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 ...
 */
          ...
          if (__pyx_t_3) {
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":156
 * 
 *                     if ind_pt == ind_len:
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)             # <<<<<<<<<<<<<<
 *                         ind_len += extend_mem
 ...
 */
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":157
 *                     if ind_pt == ind_len:
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 *                         ind_len += extend_mem             # <<<<<<<<<<<<<<
 *         return indices,ind_pt,ind_len,loaded_leaves
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":158
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 *                         ind_len += extend_mem
 *         return indices,ind_pt,ind_len,loaded_leaves             # <<<<<<<<<<<<<<
 *     ############################## Normal node ##########################################################################
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":161
 *     ############################## Normal node ##########################################################################
 *     else:
 *         if contained == 1:             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    ...
    if (__pyx_t_3) {
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":162
 *     else:
 *         if contained == 1:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)
 *         else:
 */
      __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit(__pyx_v_l_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_max_pts, __pyx_v_loaded_leaves, 1);
      __pyx_t_12 = __pyx_t_4.f0;
      __pyx_t_2 = __pyx_t_4.f1;
      __pyx_t_1 = __pyx_t_4.f2;
      __pyx_t_8 = __pyx_t_4.f3;
      __pyx_v_indices = __pyx_t_12;
      __pyx_v_ind_pt = __pyx_t_2;
      __pyx_v_ind_len = __pyx_t_1;
      __pyx_v_loaded_leaves = __pyx_t_8;

      /* "py_kdtree/cython/float64/box_query.pyx":163
 *         if contained == 1:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *         else:
 *             l_bounds = tree[l_idx]
 */
      __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit(__pyx_v_r_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_max_pts, __pyx_v_loaded_leaves, 1);
      __pyx_t_12 = __pyx_t_4.f0;
      __pyx_t_1 = __pyx_t_4.f1;
      __pyx_t_2 = __pyx_t_4.f2;
      __pyx_t_8 = __pyx_t_4.f3;
      __pyx_v_indices = __pyx_t_12;
      __pyx_v_ind_pt = __pyx_t_1;
      __pyx_v_ind_len = __pyx_t_2;
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":165
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)
 *         else:
 *             l_bounds = tree[l_idx]             # <<<<<<<<<<<<<<
 *             r_bounds = tree[r_idx]
...
__pyx_v_l_bounds = __pyx_t_13;
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":166
 *         else:
 *             l_bounds = tree[l_idx]
 *             r_bounds = tree[r_idx]             # <<<<<<<<<<<<<<
 *             ret = check_contained(l_bounds,mins,maxs)
...
__pyx_v_r_bounds = __pyx_t_13;
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":167
 *             l_bounds = tree[l_idx]
 *             r_bounds = tree[r_idx]
 *             ret = check_contained(l_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *             if ret == 1:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":168
 *             r_bounds = tree[r_idx]
 *             ret = check_contained(l_bounds,mins,maxs)
 *             if ret == 1:             # <<<<<<<<<<<<<<
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":169
 *             ret = check_contained(l_bounds,mins,maxs)
 *             if ret == 1:
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":171
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)
 *             else:
 *                 ret = check_intersect(l_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *                 if ret == 1:
 ...
 */
      /*else*/ {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":172
 *             else:
 *                 ret = check_intersect(l_bounds,mins,maxs)
 *                 if ret == 1:             # <<<<<<<<<<<<<<
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,0)
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":173
 *                 ret = check_intersect(l_bounds,mins,maxs)
 *                 if ret == 1:
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,0)             # <<<<<<<<<<<<<<
 * 
 *             ret = check_contained(r_bounds,mins,maxs)
 */
          __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit(__pyx_v_l_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_max_pts, __pyx_v_loaded_leaves, 0);
          __pyx_t_12 = __pyx_t_4.f0;
          __pyx_t_1 = __pyx_t_4.f1;
          __pyx_t_2 = __pyx_t_4.f2;
          __pyx_t_8 = __pyx_t_4.f3;
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":175
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,0)
 * 
 *             ret = check_contained(r_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *             if ret == 1:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":176
 * 
 *             ret = check_contained(r_bounds,mins,maxs)
 *             if ret == 1:             # <<<<<<<<<<<<<<
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":177
 *             ret = check_contained(r_bounds,mins,maxs)
 *             if ret == 1:
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":179
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,1)
 *             else:
 *                 ret = check_intersect(r_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *                 if ret == 1:
 ...
 */
      /*else*/ {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":180
 *             else:
 *                 ret = check_intersect(r_bounds,mins,maxs)
 *                 if ret == 1:             # <<<<<<<<<<<<<<
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,0)
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":181
 *                 ret = check_intersect(r_bounds,mins,maxs)
 *                 if ret == 1:
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,0)             # <<<<<<<<<<<<<<
 * 
 *     return indices,ind_pt,ind_len,loaded_leaves
 */
          __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit(__pyx_v_r_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_max_pts, __pyx_v_loaded_leaves, 0);
          __pyx_t_12 = __pyx_t_4.f0;
          __pyx_t_1 = __pyx_t_4.f1;
          __pyx_t_2 = __pyx_t_4.f2;
          __pyx_t_8 = __pyx_t_4.f3;
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":183
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_pts,loaded_leaves,0)
 * 
 *     return indices,ind_pt,ind_len,loaded_leaves             # <<<<<<<<<<<<<<
 * 
...
/* "py_kdtree/cython/float64/box_query.pyx":187
 * @cython.boundscheck(False) # turn off bounds-checking for entire function
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
...
static __pyx_ctuple_long__ptr__and_long__and_long__and_int __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit_leaves(int __pyx_v_node_idx, __Pyx_memviewslice __pyx_v_mins, __Pyx_memviewslice __pyx_v_maxs, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, long *__pyx_v_indices, long __pyx_v_ind_pt, long __pyx_v_ind_len, __Pyx_memviewslice __pyx_v_mmap, long __pyx_v_extend_mem, int __pyx_v_max_leaves, int __pyx_v_loaded_leaves, int __pyx_v_contained) {
  int __pyx_v_l_idx;
  int __pyx_v_r_idx;
  int __pyx_v_ret;
  int __pyx_v_lf_idx;
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":190
 *                           long* indices, long ind_pt,long ind_len,const double[:,:,::1] mmap,long extend_mem, int max_leaves,int loaded_leaves, int contained) nogil:
 *     cdef int l_idx, r_idx,intersects, ret,lf_idx,isin,j,k
 *     l_idx,r_idx = (2*node_idx)+1, (2*node_idx)+2             # <<<<<<<<<<<<<<
 *     cdef double[:,:] bounds,l_bounds,r_bounds
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":194
 *     cdef double leaf_val
 * 
 ...
 *     ############################## Leaf ##########################################################################
 */
  __pyx_t_3 = ((__pyx_v_loaded_leaves == __pyx_v_max_leaves) != 0);
  if (__pyx_t_3) {

    /* "py_kdtree/cython/float64/box_query.pyx":195
 * 
 *     if loaded_leaves == max_leaves:
 *         return indices,ind_pt,ind_len,loaded_leaves             # <<<<<<<<<<<<<<
 *     ############################## Leaf ##########################################################################
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":197
 *         return indices,ind_pt,ind_len,loaded_leaves
 *     ############################## Leaf ##########################################################################
 *     if (l_idx >= tree.shape[0]) and (r_idx >= tree.shape[0]):             # <<<<<<<<<<<<<<
 *         lf_idx = n_leaves+node_idx-n_nodes
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":198
 *     ############################## Leaf ##########################################################################
 *     if (l_idx >= tree.shape[0]) and (r_idx >= tree.shape[0]):
 *         lf_idx = n_leaves+node_idx-n_nodes             # <<<<<<<<<<<<<<
 *         loaded_leaves += 1
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":199
 *     if (l_idx >= tree.shape[0]) and (r_idx >= tree.shape[0]):
 *         lf_idx = n_leaves+node_idx-n_nodes
 *         loaded_leaves += 1             # <<<<<<<<<<<<<<
 *         if contained == 1:
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":200
 *         lf_idx = n_leaves+node_idx-n_nodes
 *         loaded_leaves += 1
 *         if contained == 1:             # <<<<<<<<<<<<<<
 *             for j in range(mmap.shape[1]):
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":201
 *         loaded_leaves += 1
 *         if contained == 1:
 *             for j in range(mmap.shape[1]):             # <<<<<<<<<<<<<<
 *                 if j == mmap.shape[1]-1:
 ...
 */
      ...
      for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":202
 *         if contained == 1:
 *             for j in range(mmap.shape[1]):
 *                 if j == mmap.shape[1]-1:             # <<<<<<<<<<<<<<
 *                     if mmap[lf_idx,j,0] == -1.:
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":203
 *             for j in range(mmap.shape[1]):
 *                 if j == mmap.shape[1]-1:
 *                     if mmap[lf_idx,j,0] == -1.:             # <<<<<<<<<<<<<<
 *                         continue
 ...
 */
          ...
          if (__pyx_t_3) {
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":204
 *                 if j == mmap.shape[1]-1:
 *                     if mmap[lf_idx,j,0] == -1.:
 *                         continue             # <<<<<<<<<<<<<<
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":205
 *                     if mmap[lf_idx,j,0] == -1.:
 *                         continue
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])             # <<<<<<<<<<<<<<
 *                 ind_pt += 1
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":206
 *                         continue
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])
 *                 ind_pt += 1             # <<<<<<<<<<<<<<
 *                 if ind_pt == ind_len:
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":207
 *                 indices[ind_pt] = int(mmap[lf_idx,j,0])
 *                 ind_pt += 1
 *                 if ind_pt == ind_len:             # <<<<<<<<<<<<<<
 *                     indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":208
 *                 ind_pt += 1
 *                 if ind_pt == ind_len:
 *                     indices = resize_long_array(indices,ind_len,ind_len+extend_mem)             # <<<<<<<<<<<<<<
 *                     ind_len += extend_mem
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":209
 *                 if ind_pt == ind_len:
 *                     indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 *                     ind_len += extend_mem             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":211
 *                     ind_len += extend_mem
 *         else:
 *             for j in range(mmap.shape[1]):             # <<<<<<<<<<<<<<
 *                 k = 0
 ...
 */
    /*else*/ {
      ...
      for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":212
 *         else:
 *             for j in range(mmap.shape[1]):
 *                 k = 0             # <<<<<<<<<<<<<<
 *                 isin = 0
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":213
 *             for j in range(mmap.shape[1]):
 *                 k = 0
 *                 isin = 0             # <<<<<<<<<<<<<<
 *                 while (k < mmap.shape[2]-1) and (isin == k):
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":214
 *                 k = 0
 *                 isin = 0
 *                 while (k < mmap.shape[2]-1) and (isin == k):             # <<<<<<<<<<<<<<
 *                     if j == mmap.shape[1]-1:
 ...
 */
        while (1) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":215
 *                 isin = 0
 *                 while (k < mmap.shape[2]-1) and (isin == k):
 *                     if j == mmap.shape[1]-1:             # <<<<<<<<<<<<<<
 *                         if mmap[lf_idx,j,0] == -1.:
 ...
 */
          ...
          if (__pyx_t_3) {
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":216
 *                 while (k < mmap.shape[2]-1) and (isin == k):
 *                     if j == mmap.shape[1]-1:
 *                         if mmap[lf_idx,j,0] == -1.:             # <<<<<<<<<<<<<<
 *                             k += 1
 ...
 */
            ...
            if (__pyx_t_3) {
              ...
              /* "py_kdtree/cython/float64/box_query.pyx":217
 *                     if j == mmap.shape[1]-1:
 *                         if mmap[lf_idx,j,0] == -1.:
 *                             k += 1             # <<<<<<<<<<<<<<
 *                             continue
 ...
 */
              ...
              /* "py_kdtree/cython/float64/box_query.pyx":218
 *                         if mmap[lf_idx,j,0] == -1.:
 *                             k += 1
 *                             continue             # <<<<<<<<<<<<<<
 *                     leaf_val = mmap[lf_idx,j,k+1]
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":219
 *                             k += 1
 *                             continue
 *                     leaf_val = mmap[lf_idx,j,k+1]             # <<<<<<<<<<<<<<
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":220
 *                             continue
 *                     leaf_val = mmap[lf_idx,j,k+1]
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):             # <<<<<<<<<<<<<<
 *                         isin += 1
 ...
 */
          ...
          if (__pyx_t_3) {
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":221
 *                     leaf_val = mmap[lf_idx,j,k+1]
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):
 *                         isin += 1             # <<<<<<<<<<<<<<
 *                     k += 1
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":222
 *                     if (leaf_val >= mins[k]) and (leaf_val <= maxs[k]):
 *                         isin += 1
 *                     k += 1             # <<<<<<<<<<<<<<
 *                 if isin == k:
 ...
 */
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":223
 *                         isin += 1
 *                     k += 1
 *                 if isin == k:             # <<<<<<<<<<<<<<
 *                     indices[ind_pt] = int(mmap[lf_idx,j,0])
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":224
 *                     k += 1
 *                 if isin == k:
 *                     indices[ind_pt] = int(mmap[lf_idx,j,0])             # <<<<<<<<<<<<<<
 *                     ind_pt += 1
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":225
 *                 if isin == k:
 *                     indices[ind_pt] = int(mmap[lf_idx,j,0])
 *                     ind_pt += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":227
 *                     ind_pt += 1
 * 
 *                     if ind_pt == ind_len:             # <<<<<<<<<<<<<<
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 ...
 */
          ...
          if (__pyx_t_3) {
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":228
 * 
 *                     if ind_pt == ind_len:
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)             # <<<<<<<<<<<<<<
 *                         ind_len += extend_mem
 ...
 */
            ...
            /* "py_kdtree/cython/float64/box_query.pyx":229
 *                     if ind_pt == ind_len:
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 *                         ind_len += extend_mem             # <<<<<<<<<<<<<<
 *         return indices,ind_pt,ind_len,loaded_leaves
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":230
 *                         indices = resize_long_array(indices,ind_len,ind_len+extend_mem)
 *                         ind_len += extend_mem
 *         return indices,ind_pt,ind_len,loaded_leaves             # <<<<<<<<<<<<<<
 *     ############################## Normal node ##########################################################################
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":233
 *     ############################## Normal node ##########################################################################
 *     else:
 *         if contained == 1:             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    ...
    if (__pyx_t_3) {
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":234
 *     else:
 *         if contained == 1:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)
 *         else:
 */
      __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit_leaves(__pyx_v_l_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_max_leaves, __pyx_v_loaded_leaves, 1);
      __pyx_t_12 = __pyx_t_4.f0;
      __pyx_t_2 = __pyx_t_4.f1;
      __pyx_t_1 = __pyx_t_4.f2;
      __pyx_t_8 = __pyx_t_4.f3;
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":235
 *         if contained == 1:
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *         else:
 *             l_bounds = tree[l_idx]
 */
      __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit_leaves(__pyx_v_r_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_max_leaves, __pyx_v_loaded_leaves, 1);
      __pyx_t_12 = __pyx_t_4.f0;
      __pyx_t_1 = __pyx_t_4.f1;
      __pyx_t_2 = __pyx_t_4.f2;
      __pyx_t_8 = __pyx_t_4.f3;
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":237
 *             indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)
 *         else:
 *             l_bounds = tree[l_idx]             # <<<<<<<<<<<<<<
 *             r_bounds = tree[r_idx]
...
__pyx_v_l_bounds = __pyx_t_13;
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":238
 *         else:
 *             l_bounds = tree[l_idx]
 *             r_bounds = tree[r_idx]             # <<<<<<<<<<<<<<
 *             ret = check_contained(l_bounds,mins,maxs)
...
__pyx_v_r_bounds = __pyx_t_13;
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":239
 *             l_bounds = tree[l_idx]
 *             r_bounds = tree[r_idx]
 *             ret = check_contained(l_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *             if ret == 1:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":240
 *             r_bounds = tree[r_idx]
 *             ret = check_contained(l_bounds,mins,maxs)
 *             if ret == 1:             # <<<<<<<<<<<<<<
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":241
 *             ret = check_contained(l_bounds,mins,maxs)
 *             if ret == 1:
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":243
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)
 *             else:
 *                 ret = check_intersect(l_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *                 if ret == 1:
 ...
 */
      /*else*/ {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":244
 *             else:
 *                 ret = check_intersect(l_bounds,mins,maxs)
 *                 if ret == 1:             # <<<<<<<<<<<<<<
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,0)
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":245
 *                 ret = check_intersect(l_bounds,mins,maxs)
 *                 if ret == 1:
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,0)             # <<<<<<<<<<<<<<
 * 
 *             ret = check_contained(r_bounds,mins,maxs)
 */
          __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit_leaves(__pyx_v_l_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_max_leaves, __pyx_v_loaded_leaves, 0);
          __pyx_t_12 = __pyx_t_4.f0;
          __pyx_t_1 = __pyx_t_4.f1;
          __pyx_t_2 = __pyx_t_4.f2;
          __pyx_t_8 = __pyx_t_4.f3;
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":247
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(l_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,0)
 * 
 *             ret = check_contained(r_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *             if ret == 1:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":248
 * 
 *             ret = check_contained(r_bounds,mins,maxs)
 *             if ret == 1:             # <<<<<<<<<<<<<<
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":249
 *             ret = check_contained(r_bounds,mins,maxs)
 *             if ret == 1:
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":251
 *                 indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,1)
 *             else:
 *                 ret = check_intersect(r_bounds,mins,maxs)             # <<<<<<<<<<<<<<
 *                 if ret == 1:
 ...
 */
      /*else*/ {
        ...
        /* "py_kdtree/cython/float64/box_query.pyx":252
 *             else:
 *                 ret = check_intersect(r_bounds,mins,maxs)
 *                 if ret == 1:             # <<<<<<<<<<<<<<
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,0)
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/box_query.pyx":253
 *                 ret = check_intersect(r_bounds,mins,maxs)
 *                 if ret == 1:
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,0)             # <<<<<<<<<<<<<<
 * 
 *     return indices,ind_pt,ind_len,loaded_leaves
 */
          __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_9box_query__recursive_search_box_limit_leaves(__pyx_v_r_idx, __pyx_v_mins, __pyx_v_maxs, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_ind_pt, __pyx_v_ind_len, __pyx_v_mmap, __pyx_v_extend_mem, __pyx_v_max_leaves, __pyx_v_loaded_leaves, 0);
          __pyx_t_12 = __pyx_t_4.f0;
          __pyx_t_1 = __pyx_t_4.f1;
          __pyx_t_2 = __pyx_t_4.f2;
          __pyx_t_8 = __pyx_t_4.f3;
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":255
 *                     indices,ind_pt,ind_len,loaded_leaves = _recursive_search_box_limit_leaves(r_idx,mins,maxs,tree,n_leaves,n_nodes,indices,ind_pt,ind_len,mmap,extend_mem,max_leaves,loaded_leaves,0)
 * 
 *     return indices,ind_pt,ind_len,loaded_leaves             # <<<<<<<<<<<<<<
 * 
...
/* "py_kdtree/cython/float64/box_query.pyx":259
 * @cython.boundscheck(False) # turn off bounds-checking for entire function
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
...
static int __pyx_f_9py_kdtree_6cython_7float64_9box_query_check_intersect(__Pyx_memviewslice __pyx_v_bounds, __Pyx_memviewslice __pyx_v_mins, __Pyx_memviewslice __pyx_v_maxs) {
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":262
 *     cdef int intersects, idx
 * 
 *     intersects = 0             # <<<<<<<<<<<<<<
 *     idx = 0
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":263
 * 
 *     intersects = 0
 *     idx = 0             # <<<<<<<<<<<<<<
 *     while (idx < bounds.shape[0]) and (intersects == idx):
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":264
 *     intersects = 0
 *     idx = 0
 *     while (idx < bounds.shape[0]) and (intersects == idx):             # <<<<<<<<<<<<<<
 *         if (bounds[idx,1] >= mins[idx]) and (bounds[idx,0] <= maxs[idx]):
 ...
 */
  while (1) {
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":265
 *     idx = 0
 *     while (idx < bounds.shape[0]) and (intersects == idx):
 *         if (bounds[idx,1] >= mins[idx]) and (bounds[idx,0] <= maxs[idx]):             # <<<<<<<<<<<<<<
 *             intersects += 1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":266
 *     while (idx < bounds.shape[0]) and (intersects == idx):
 *         if (bounds[idx,1] >= mins[idx]) and (bounds[idx,0] <= maxs[idx]):
 *             intersects += 1             # <<<<<<<<<<<<<<
 *         idx += 1
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":267
 *         if (bounds[idx,1] >= mins[idx]) and (bounds[idx,0] <= maxs[idx]):
 *             intersects += 1
 *         idx += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":269
 *         idx += 1
 * 
 *     if intersects == idx:             # <<<<<<<<<<<<<<
 *         intersects = 1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":270
 * 
 *     if intersects == idx:
 *         intersects = 1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":272
 *         intersects = 1
 *     else:
 *         intersects = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":274
 *         intersects = 0
 * 
 *     return intersects             # <<<<<<<<<<<<<<
 * 
...
/* "py_kdtree/cython/float64/box_query.pyx":278
 * @cython.boundscheck(False) # turn off bounds-checking for entire function
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
...
static int __pyx_f_9py_kdtree_6cython_7float64_9box_query_check_contained(__Pyx_memviewslice __pyx_v_bounds, __Pyx_memviewslice __pyx_v_mins, __Pyx_memviewslice __pyx_v_maxs) {
  int __pyx_v_contained;
  int __pyx_v_idx;
  int __pyx_r;
  int __pyx_t_1;
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":281
 *     cdef int contained, idx
 * 
 *     contained = 0             # <<<<<<<<<<<<<<
 *     idx = 0
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":282
 * 
 *     contained = 0
 *     idx = 0             # <<<<<<<<<<<<<<
 *     while (idx < bounds.shape[0]) and (contained == idx):
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":283
 *     contained = 0
 *     idx = 0
 *     while (idx < bounds.shape[0]) and (contained == idx):             # <<<<<<<<<<<<<<
 *         if (bounds[idx,0] >= mins[idx]) and (bounds[idx,1] <= maxs[idx]):
 ...
 */
  while (1) {
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":284
 *     idx = 0
 *     while (idx < bounds.shape[0]) and (contained == idx):
 *         if (bounds[idx,0] >= mins[idx]) and (bounds[idx,1] <= maxs[idx]):             # <<<<<<<<<<<<<<
 *             contained += 1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "py_kdtree/cython/float64/box_query.pyx":285
 *     while (idx < bounds.shape[0]) and (contained == idx):
 *         if (bounds[idx,0] >= mins[idx]) and (bounds[idx,1] <= maxs[idx]):
 *             contained += 1             # <<<<<<<<<<<<<<
 *         idx += 1
 ...
 */
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":286
 *         if (bounds[idx,0] >= mins[idx]) and (bounds[idx,1] <= maxs[idx]):
 *             contained += 1
 *         idx += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":288
 *         idx += 1
 * 
 *     if contained == idx:             # <<<<<<<<<<<<<<
 *         contained = 1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "py_kdtree/cython/float64/box_query.pyx":289
 * 
 *     if contained == idx:
 *         contained = 1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":291
 *         contained = 1
 *     else:
 *         contained = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":293
 *         contained = 0
 * 
 *     return contained             # <<<<<<<<<<<<<<
 * 
...
/* "py_kdtree/cython/float64/box_query.pyx":299
 * @cython.boundscheck(False) # turn off bounds-checking for entire function
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
...
static long *__pyx_f_9py_kdtree_6cython_7float64_9box_query_resize_long_array(long *__pyx_v_arr, CYTHON_UNUSED long __pyx_v_old_len, long __pyx_v_new_len) {
  long *__pyx_v_mem;
  long *__pyx_r;

  /* "py_kdtree/cython/float64/box_query.pyx":301
 * cdef long* resize_long_array(long* arr,long old_len, long new_len) nogil:
 *     cdef long i
 *     cdef long* mem = <long*> realloc(arr,new_len * sizeof(long))             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":307
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":308
 *     #    mem[i] = arr[i]
 *     arr = mem
 *     return arr             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "py_kdtree.cython.float64.box_query.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "py_kdtree.cython.float64.box_query.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "py_kdtree.cython.float64.box_query.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "py_kdtree.cython.float64.box_query._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"recursive_search_box", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9py_kdtree_6cython_7float64_9box_query_1recursive_search_box, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_box_query(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_box_query},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_arr_loaded, __pyx_k_arr_loaded, sizeof(__pyx_k_arr_loaded), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_max_leaves, __pyx_k_max_leaves, sizeof(__pyx_k_max_leaves), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initbox_query(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initbox_query(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_box_query(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_box_query(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_box_query(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'box_query' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_box_query(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("box_query", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_py_kdtree__cython__float64__box_query) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "py_kdtree.cython.float64.box_query")) {
      if (unlikely(PyDict_SetItemString(modules, "py_kdtree.cython.float64.box_query", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":8
 * cimport cython
 ...
 */
  ...
  /* "py_kdtree/cython/float64/box_query.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init py_kdtree.cython.float64.box_query", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init py_kdtree.cython.float64.box_query");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
